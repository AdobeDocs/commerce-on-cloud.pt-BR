...
description: Saiba como proteger o acesso de Administrador ao seu projeto de infraestrutura em nuvem do Adobe Commerce, redefinir a senha de Proprietário da licença e fazer logon no Painel de administração.
