...
2. No painel **Todos os projetos**, selecione o projeto relevante. No canto inferior, consulte disponibilidade de espaço em disco.

[Espaço do projeto](/help/assets/disk-space.png)

## Leitura relacionada

[Gerencie o espaço em disco](https://experienceleague.adobe.com/en/docs/commerce-cloud-service/user-guide/develop/storage/manage-disk-space?lang=en) na documentação do desenvolvedor.
