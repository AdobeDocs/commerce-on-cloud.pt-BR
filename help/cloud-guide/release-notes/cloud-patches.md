...
- ![Ícone de correção](../../assets/fix.svg) **Patch** - Correção para o [Falha no check-out quando a minificação e o agrupamento JS estão habilitados](https://experienceleague.adobe.com/pt-br/docs/experience-cloud-kcs/kbarticles/ka-27997)) problema descrito na *Base de Dados de Conhecimento Commerce&quot; (tíquetes AC-15867 e ACSD-68617).<!-- MCLOUD-14191 -->
