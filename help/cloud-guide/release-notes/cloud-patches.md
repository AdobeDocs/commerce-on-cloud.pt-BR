...
- ![Ícone de correção](../../assets/fix.svg) **Melhorias de segurança**—Suporte incluído para o patch de segurança isolado de setembro de 2026.<!-- MCLOUD-15053 -->

## v1.1.19

Data de lançamento: 19 de agosto de 2026

- ![Ícone de correção](../../assets/fix.svg) **Confiabilidade de patch** — Tratamento de patch aprimorado para implantações confiáveis na nuvem.<!-- MCLOUD-15325/ACSEC-561/MCLOUD-15451/MCLOUD-15455 -->
- ![Ícone de correção](../../assets/fix.svg) **Melhorias de cache**—Aprimoramento do suporte de cache Symfony_l2 para conexões secundárias Redis e Valkey e resolução de problemas relacionados a cache, índice de marca, pré-carregamento e implantação estática..<!-- MCLOUD-15433 -->
...
- ![ícone de correção](../../assets/fix.svg) **Desempenho de cache L2 otimizado do Symfony, confiabilidade e gerenciamento de marcas** — melhor escalabilidade do cache, E/S desnecessária reduzida do sistema de arquivos, consistência aprimorada do cache e associações de marcas obsoletas resolvidas, gravações remotas redundantes e limpeza de remoção do cache L1.<!-- ACP2E-5132 -->
- ![Ícone de correção](../../assets/fix.svg) **Melhorias de segurança**—Compatibilidade aprimorada para o patch de segurança isolado de julho de 2026.<!-- AC-17674 -->

## v1.1.16

Data de lançamento: 23 de julho de 2026

- ![ícone de correção](../../assets/fix.svg) **Desempenho e confiabilidade aprimorados do cache L2 do Symfony**—Armazenamento otimizado de marcas de cache para symfony_l2, invalidação aprimorada do cache e compactação Redis/Valkey (compress_data) habilitada por padrão para reduzir o consumo de memória e o tráfego de rede.<!-- ACP2E-5132 -->

## v1.1.15

Data de lançamento: 14 de julho de 2026

- ![Ícone de correção](../../assets/fix.svg) **Melhorias de segurança** — Correções de segurança referenciadas na [Atualização de Segurança do Adobe Commerce APSB26-73](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-37421).<!--MCLOUD-15066 -->

## v1.1.14

Data de lançamento: 06 de maio de 2026

- ![Ícone de correção](../../assets/fix.svg) **Visibilidade de versão de patch**—Visibilidade de versão de patch de nuvem corrigida em ambientes de nuvem.<!--MCLOUD-14221 -->
- ![ícone de correção](../../assets/fix.svg) **limpeza do PHPUnit**—Avisos do PHPUnit corrigidos<!--MCLOUD-14717 -->
- ![novo ícone ](../../assets/new.svg)**Correções cosméticas**—Melhorias cosméticas adicionadas.<!--MCLOUD-14686 -->

## v1.1.13

Data de lançamento: 05 de março de 2026

- ![novo ícone](../../assets/new.svg) **PHP 8.5**—Suporte adicionado para PHP 8.5.<!-- MCLOUD-14181 -->
- ![ícone de correção](../../assets/fix.svg) **Testes funcionais atualizados para o PHP 8.x**—Remoção de testes PHP 7.x herdados, inclusão de cobertura de teste do PHP 8.1 e 8.2 e atualizações de versões do Adobe Commerce.<!-- MCLOUD-14203 -->

## v1.1.12

Data de lançamento: 13 de novembro de 2025

- ![Ícone de correção](../../assets/fix.svg) **Pacote do Symfony**—Suporte adicionado para os pacotes YAML do Symfony mais recentes.<!-- MCLOUD-14020 -->
- ![Ícone de correção](../../assets/fix.svg) **Patch**—A correção para o [Check-out falha quando a minificação e o agrupamento JS estão habilitados](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27997) problema descrito na *Base de Dados de Conhecimento Commerce*.
- ![ícone de correção](../../assets/fix.svg) **Exibição de Categoria Aprimorada**—MCLOUD-13752: Melhorar exibição de categoria.<!-- MCLOUD-13752 | MCLOUD-14139  -->

## v1.1.11

Data de lançamento: 09 de setembro de 2025

- ![ícone de correção](../../assets/fix.svg) **WebAPI** — Correção para CVE-2025-54236.<!-- MCLOUD-14016 -->

## v1.1.10

Data de lançamento: 07 de agosto de 2025

- ![novo ícone](../../assets/new.svg) **PHP 8.4**—Testes funcionais adicionados.<!-- MCLOUD-13312 -->

## v1.1.9

Data de lançamento: 09 de junho de 2025

- ![ícone de correção](../../assets/fix.svg) **Modo de Exibição de Categoria Aprimorado**—Melhorar modo de exibição de categoria.<!-- MCLOUD-13752     - -->
- ![ícone de correção](../../assets/fix.svg) **Cache de Administração Aprimorado**—Melhore a eficiência do cache de administração CVE-2025-47110.<!-- MCLOUD-13753     - -->

## v1.1.8

Data de lançamento: 03 de junho de 2025

- ![ícone de correção](../../assets/fix.svg) **Compatibilidade aprimorada com 2.4.8**—Foram atualizadas bibliotecas de terceiros para melhor compatibilidade com 2.4.8<!-- MCLOUD-13707     - -->

## v1.1.7

Data de lançamento: 05 de maio de 2025

- ![novo ícone](../../assets/new.svg) **Patch atualizado para Commerce 2.4.4 para 2.4.8**—Este é um patch atualizado para [CVE-2025-24434](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27148), que foi lançado em 1.1.7<!-- MCLOUD-13619 -->

## v1.1.6

Data de lançamento: 24 de abril de 2025

- ![novo ícone](../../assets/new.svg) **Patch atualizado para Commerce 2.4.4 para 2.4.7**—Esta atualização é um patch atualizado para [CVE-2025-24434](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27149), que foi lançado em 1.1.4<!-- MCLOUD-13240 -->
...
- ![novo ícone](../../assets/new.svg) **Adição de patch para Commerce 2.4.4 a 2.4.7**—Esta atualização patches [CVE-2025-24434](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27149).<!-- MCLOUD-13240     - -->
...
- ![Ícone de correção](../../assets/fix.svg) **Adição de correção para Commerce 2.4.4 para 2.4.7**—Esta atualização corrige uma vulnerabilidade crítica [CVE-2024-45115](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27151) para Adobe Commerce ao usar o módulo B2B.<!-- MCLOUD-12980 - -->

## v1.1.1

Data de lançamento: 5 de novembro de 2024

- ![Ícone de correção](../../assets/fix.svg) **Adição de correção para o Commerce 2.4.4 para 2.4.7**—Esta atualização corrige uma vulnerabilidade crítica do [CVE-2024-34102](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27136) CosmicSting.<!-- MCLOUD-12980 - -->
...
- **Melhorias de cache**—Este patch melhora a eficiência do cache de layout, reduzindo o uso de memória, para as versões 2.4.4 e posteriores do Adobe Commerce.<!-- MCLOUD-11514 -->
...
Consulte [O administrador não pode criar pedido/reordenação quando o pagamento do Braintree está habilitado](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27169).
...
- **Erro de PHP**—Corrigiu um erro `PHP error 'Undefined variable: errorMessage' ...`. Erro ao tentar aplicar um patch.<!-- ACP2E-138 -->
...
- **Check-out do PayPal Express**—Este patch resolve um problema no qual a região do país do endereço de entrega é inserida manualmente em vez de selecionada no menu suspenso. Consulte a descrição completa do patch na página de download de patches.
...
Todos os patches do Magento Open Source 2.x da página de downloads de software estão incluídos na versão magento/magento-cloud-patches v1.0.1. Para evitar conflitos, remova todos os patches copiados anteriormente no projeto.

Esta versão inclui os seguintes patches e correções críticas:

- **Corrigir bloqueios de cron e melhorar o bloqueio de cron**—

  - Corrige um problema em que alguns trabalhos cron não estão sendo executados devido a um valor de status incorreto na tabela `cron_schedule`. Agora, a estrutura de bloqueio do Adobe Commerce é usada para verificar e atualizar o status do trabalho cron em vez de usar a tabela `cron_schedule`. Os trabalhos do CRON que terminaram com um status de erro são repetidos durante a próxima execução do CRON, em vez de aguardarem 24 horas.

  - Para evitar deadlock durante atualizações dos dados na tabela `cron_schedule`, adicione uma operação _retry_.
...
- **Patches de segurança do Page Builder para as versões 2.3.1.x e 2.3.2.x**—Corrige um problema de visualização do Page Builder que permite que usuários não autenticados acionem a execução de código arbitrário (RCE) e vazamentos de informações globais. Esse problema pode ocorrer ao usar versões não compatíveis do Page Builder com as versões 2.3.1 e 2.3.2 do Adobe Commerce.<!--MAGECLOUD-4649-->
