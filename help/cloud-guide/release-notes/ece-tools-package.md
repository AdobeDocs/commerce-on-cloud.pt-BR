...
- ![ícone de correção](../../assets/fix.svg) **Cobertura de teste funcional do Valkey 8.5**—Cobertura aprimorada para a configuração de cache L2 do Symfony.<!-- MCLOUD-15487 -->
- ![Ícone de correção](../../assets/fix.svg) **Melhorias no cache**—Resolveu um problema de isolamento do cache de página.<!-- MCLOUD-15509 -->
- ![Ícone de correção](../../assets/fix.svg) **Melhorias no Redis e Valkey**—Manuseio de `REDIS_BACKEND` e `VALKEY_BACKEND` aprimorado para dar suporte a configurações de cache herdadas e modernas (Symfony Cache, 2.4.9+) Redis e Valkey.<!-- MCLOUD-15546 -->
...
- ![novo ícone](../../assets/new.svg) **RabbitMQ**—Suporte a RabbitMQ 4.3 adicionado.<!-- MCLOUD-15088 -->
- ![Ícone de correção](../../assets/fix.svg) **Configuração Redis Lua** - Adicionado suporte a `USE_LUA_ON_GC` e descontinuado `LUA_KEY`.<!-- MCLOUD-15048 -->
- ![Ícone de correção](../../assets/fix.svg) **Cache L2 do Symfony**-Correção da compatibilidade ece-tools com a configuração de cache do Adobe Commerce 2.4.9<!-- MCLOUD-15114 -->
...
- ![novo ícone](../../assets/new.svg) **Suporte adicionado para Adobe I/O Events para Adobe Commerce**. Os desenvolvedores de extensão agora podem usar a estrutura [Adobe I/O Events](https://developer.adobe.com/events/docs/) para enviar informações de eventos Commerce de instâncias da Nuvem para seus aplicativos, gravadas para o [Adobe App Builder](https://developer.adobe.com/app-builder/docs/intro_and_overview/). O Adobe I/O Events para Adobe Commerce está em Visualização de Parceiro.<!-- CEXT-932 -->
