...
description: Saiba como concluir as etapas finais para iniciar sua loja de infraestrutura em nuvem do Adobe Commerce, incluindo tíquetes de suporte, transferência de DNS e verificação de site.
